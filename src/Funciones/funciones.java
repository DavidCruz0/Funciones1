...
public class funciones {
		...
		public static String angelapeña (String frase){
			...
			public static String manuel(String palabraencriptar) {
		        /*
		        ...
		        String espacios = "             ";// los espacios los uso para separar los cuadros cuando la posicion de la
		                                          // letra es > a 13
		        String cuadradouno = ".............";
		        String cuadrodefitivo = "";// en esta variable es en donde se va a ir guardando la encriptacion letra por
		                                   // letra
		    ...
		    public static void main(String[] args) throws Exception {
		        ...
		        palabraencriptada = manuel(palabraencriptar);
		        System.out.println(palabraencriptada);
		        lectura.close();
		    }
		    
		public static String selene (String frase){
			String texto=frase;
		...
		public static String yirman (String frase, int año, int mes) {
			/*
		...
		public static String david(String palabra) { 
		 ...
		 */
		public static String nicolcepeda(String frase) {
			/*
		...
		public static String samiryate( String texto){
			        // Creo la clase Scanner y la importo para que nos permite obtener la entrada de datos por teclado:
			        Scanner entrada = new Scanner(System.in);
			        ...
			        // Cierro el Scanner para el metodo samirYate
			        entrada.close();
		...
		public static String lauracorrea (String palabra) {
	...
	{"magdalena","fishburne","crucial","kendrik","suena","perfume","goodgirls","bahia","swift","semejante","akkas","ambulance","tiempos","mango","ghost","zepet","buque","world","misma","anestecia","uchuvas","alvin","williamwilson","boxeo","nsync","gozar"};
		...
		public static String eliascamargo (String frase) {
		...
		public static String thomasespinel (String palabra, int numero, boolean desicion) {// creamos metodo para encriptar la palabra
			int posicion=0;
		...
		public static String juanfuquene(String frase) {
		...
		public static String samuelcastro (String palabra) {
		 ...
		 public static String yaiderbecerra(String palabra) {
			return "";
